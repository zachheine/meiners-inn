...
/* ES module consumers (Claude Code / bundlers) can also do:
     import "./hotel-proforma.js";
     const { computeScenario } = window.HotelProForma;
   or convert the trailing assignment to `export default API;`         */
